...
const ResetPassword = () => {
    ...
    console.log("resetPassword details", resetPassword)
    ...
    async function submitPassword (e) {
        ...
        try {
            const response = await axios.post("http://localhost:3131/api/v1/user/reset", resetPassword, {
                headers:{
            ...
            console.log("Error caught by submitPassword", error)
        }
    }
    ...
    return (
        ...
        <div class="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
            <div class="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
                ...
                <form action="#" method="POST" class="mt-8" onSubmit={submitPassword}>
                    <div class="space-y-5">
                        <div>
